...
namespace Back_end.DB
{
    public class MyDbContext : DbContext
    {
        ...
        .WithMany(c=>c.Accepted)
        .HasForeignKey(b=>b.ProcessedByUserId)
        .OnDelete(DeleteBehavior.Restrict)
        .IsRequired(false);
        //     // modelBuilder.Entity<Assignment>()
        //     //     .HasOne<ReturningRequest>(a => a.ReturningRequest)
        //     //     .WithOne(r => r.Assignment)
        //     //     .HasForeignKey<ReturningRequest>(b => b.AssignmentId)
        //     //     .IsRequired();
        //     // modelBuilder.Entity<ReturningRequest>()
        //     //     .HasOne(b => b.RequestedBy)
        ...
        //     //     .IsRequired();
        //     // modelBuilder.Entity<ReturningRequest>()
        //     //     .HasOne(b => b.AcceptedBy)
        //     //     .WithMany(c => c.AcceptedRequests)
        //     //     .HasForeignKey(b => b.AcceptedByUserId)
